...
Discussion of this work occurs on the [Border Gateway Protocol
Working Group mailing list](mailto:bgp@ans.net)
([archive](ftp.ans.net:/pub/archive/iwg),
[subscribe](bgp-request@ans.net)).
...
[Working Group documents](https://datatracker.ietf.org/wg/bgp/documents/).
